;;; archboki-everforest-dark-hard-theme.el --- Everforest dark, hard contrast -*- lexical-binding: t; no-byte-compile: t; -*-
...
;; A direct port of the Everforest dark (hard contrast) palette by
...
(deftheme archboki-everforest-dark-hard
  "Everforest dark theme, hard contrast background.
Palette ported from sainnhe/everforest.")

(archboki-themes--set-faces
 'archboki-everforest-dark-hard
 '((background   . "#272e33")
   (foreground   . "#d3c6aa")
   (red          . "#e67e80")
   (green        . "#a7c080")
...
(provide-theme 'archboki-everforest-dark-hard)

;;; archboki-everforest-dark-hard-theme.el ends here
